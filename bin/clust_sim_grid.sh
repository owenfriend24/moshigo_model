...
3dClustSim -mask /home1/09123/ofriend/analysis/moshigo_model/mni_gm_2mm.nii.gz -acf 0.792 1.130 8.685 -nodec -FINAL_GM

3dClustSim -mask /scratch/09123/ofriend/moshi/grid_coding/mni/new2/smoothed/masked/mni_gm_2mm_dil_masked.nii.gz -acf 0.792 1.130 8.685 -nodec -FINAL_GM_DIL
