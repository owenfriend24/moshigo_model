...
ANTS 3 -m PR[/corral-repl/utexas/prestonlab/moshiGO1/${sub}/anatomy/brain.nii.gz, \
/corral-repl/utexas/prestonlab/moshiGO1/${sub}/anatomy/coronal_mean_brain.nii.gz,1,4] \
-t SyN[0.25] -r Gauss[3,0] -o /corral-repl/utexas/prestonlab/temple/moshigo/results/${sub}/NEW_PR_coronal_to_anat_ \
...
-t SyN[0.25] -r Gauss[3,0] -o /corral-repl/utexas/prestonlab/temple/moshigo/results/${sub}/NEW_CC_coronal_to_anat_ \
-i 30x90x20 --use-Histogram-Matching \
--number-of-affine-iterations 10000x10000x10000x10000x10000 --MI-option 32x16000
...
-i 30x90x20 \
-r Gauss[3,0] \
-o /corral-repl/utexas/prestonlab/temple/moshigo/results/${sub}/NEW_MI_coronal_to_anat_ --rigid-affine true -i 0
#
#
